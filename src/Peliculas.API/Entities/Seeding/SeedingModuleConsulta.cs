...
namespace Peliculas.API.Entities.Seeding
{
    public static class SeedingModuleConsulta
    {
        public static void seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalaCine>().HasData(SalaCine2DMegacentro, SalaCine3DMegacentro, SalaCineCXCMegacentro, SalaCine2DAcropolis, SalaCine2DAgora, SalaCine3DAgora, SalaCine2DSambil, SalaCine3DSambil);
            ...
            var SalaCineIdPropiedad = "SalaCinesId";
            ...
            modelBuilder.Entity(entidadSalaCinePelicula).HasData(
